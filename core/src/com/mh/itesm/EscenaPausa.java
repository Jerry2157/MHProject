...
public class EscenaPausa extends Stage {
    ...
    public EscenaPausa(final Pantalla pantalla,final Controller controller, Viewport vista, SpriteBatch batch) {
        ...
        // Salir
        Texture texturaBtnSalir =currentS.getManager().get("Botones/SALIR.png");
        ...
        // Continuar
        Texture texturaBtnReintentar = currentS.getManager().get("Botones/CONTINUAR.png");
        ...
        Texture texturaBtnMusica = currentS.getManager().get("Botones/Musica.png");
