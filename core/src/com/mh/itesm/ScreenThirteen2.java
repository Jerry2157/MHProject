...
public class ScreenThirteen2 extends Pantalla {//oficina director
    ...
    public ScreenThirteen2(MHMain juego, int xS, int yS) {
    ...
    public void render(float delta) {
        ...
        if((playedDialogoTwo==true || runningDialogoTwo==false)){
            controller.draw();
        }
    }
